i have built a whole bunch of alternate timelines of the star wars prequels era all based on similar ideas - anakin didn't fall, obi-wan and satine get together, sidious is defeated early, etc. however, there are some plot differences between the exact "how" these results are arrived at in each one, as well as differences in when each one diverges from canon.
...
- whether each relevant character stayed as a jedi or left the jedi; if they left, when did they leave and why
- fate of shmi and the tuskens
